...
#ADD https://repo1.maven.org/maven2/org/apache/logging/log4j/log4j-core/2.16.0/log4j-core-2.16.0.jar /usr/local/tomcat/bin/
COPY container_files/tomcat/log4j-core-2.16.0.jar /usr/local/tomcat/bin/
#ADD https://repo1.maven.org/maven2/org/apache/logging/log4j/log4j-api/2.16.0/log4j-api-2.16.0.jar /usr/local/tomcat/bin/
COPY container_files/tomcat/log4j-api-2.16.0.jar /usr/local/tomcat/bin/
#ADD https://repo1.maven.org/maven2/org/apache/logging/log4j/log4j-jul/2.16.0/log4j-jul-2.16.0.jar /usr/local/tomcat/bin/
